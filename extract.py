...
Command_result={}
file_result={}
filelocation=raw_input("Enter test files path:")
if (os.path.isdir(filelocation)== False):
    ...
    File_Report.close()
print '*'*80
print "Search completed in "+str(len(all_files))+'.'
print len(file_result.keys())+" files are having External Nav commands."
print '*'*80    
print "CommandReport.csv and FileReport.csv is generated in "
print output_path
raw_input()
raw_input()